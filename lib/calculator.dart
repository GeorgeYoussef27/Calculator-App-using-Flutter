...
import 'package:calculator_app_flutter_learning_6/my_buttons.dart';
...
class _CalculatorState extends State<Calculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        titleTextStyle: TextStyle(textBaseline: TextBaseline.alphabetic, fontSize: 26),
          ...
          children: [
            Expanded(
              ...
              child: Container(
                ...
                color: isDarkModeEnabled ? blackDarkMode : whiteColorC,
                child: Padding(
